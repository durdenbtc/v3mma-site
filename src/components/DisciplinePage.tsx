      ...
      <section className="py-16 sm:py-20 bg-[#0f1729]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-6">
            Shane Mistretta (5-4 pro, 10-4 amateur) coaches every {discipline.toLowerCase()} class personally. He&apos;s competed on FFC and Combat Night, and brings real fight experience to every session — not just textbook technique.
          </p>
