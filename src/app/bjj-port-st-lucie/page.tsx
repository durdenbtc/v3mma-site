    ...
    <DisciplinePage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "At V3 MMA, unlimited no-gi BJJ is $129/month — which includes every other class we offer. No gi to purchase, no belt testing fees, no contracts. We also offer Saturday Open Mat for additional rolling time. Your first class is free.",
        },
      ]}
      relatedDisciplines={[
